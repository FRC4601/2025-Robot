...
public class Elevator extends SubsystemBase {
  ...
  public Elevator() {
    ...
    leftWinch.configure(leftWinchConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
    rightWinch.configure(rightWinchConfig,ResetMode.kNoResetSafeParameters, PersistMode.kPersistParameters);
  }
